...
# Load book data and initialize recommendation engine
print("Loading data...")
try:
    books = pd.read_csv('../data/books.csv')
    print(f"Data loaded successfully! Shape: {books.shape}")
...
# Route to serve the home page (initial page load)
@app.route('/', methods=['GET'])
def home():
    try:
        return render_template('index.html')  # This renders the initial home page
    except Exception as e:
        print(f"Error in home route: {e}")
        return str(e), 500
